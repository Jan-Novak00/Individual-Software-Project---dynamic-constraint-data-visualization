...
class PlotCanvas:
    """
    Represents ui editation window for the plot and data view. Takes care of saving results
    """
    ...
    def _setEventRegistersLeftButton(self):
        """
        Variables which register information about events reguarding the left mouse button
        """
        self.dragEdge = None
    ...
    def _setEventRegistersRightButton(self):
        """
        Variables which register information about events reguarding the right mouse button
        """
        self.rectangleIndexToChange = None

    def _setScaleFactor(self):
        """
        Sets scale for heights
        """
        self.scaleFactor = 1
    ...
    def check_cursor(self,event):
        """
        Changes cursor based on some conditions (overwritten in subclasses, where the cursor changes based its location).
        """
    ...
    def on_savePictureButton_click(self):
        """
        Saves plot as PNG when "Save as PNG" button is clicked
        """
    ...
    def on_saveDataButton_click(self):
        """
        Saves data as CSV when "Save as CSV" button is clicked
        """
